// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "s2clientprotocol/score.proto" (package "SC2APIProtocol", syntax proto2),// tslint:disable
...
class Score$Type extends MessageType<Score> {
    constructor() {
        super("SC2APIProtocol.Score", [
            { no: 6, name: "score_type", kind: "enum", opt: true, T: () => ["SC2APIProtocol.Score.ScoreType", Score_ScoreType] },
            { no: 7, name: "score", kind: "scalar", opt: true, T: 5 /*ScalarType.INT32*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional SC2APIProtocol.ScoreDetails score_details */ 8:
                    message.scoreDetails = ScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.scoreDetails);
                    break;
                default:
    ...
    internalBinaryWrite(message: Score, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.scoreDetails)
            ScoreDetails.internalBinaryWrite(message.scoreDetails, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
...
class CategoryScoreDetails$Type extends MessageType<CategoryScoreDetails> {
    constructor() {
        super("SC2APIProtocol.CategoryScoreDetails", [
            { no: 1, name: "none", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 2, name: "army", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 3, name: "economy", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 4, name: "technology", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 5, name: "upgrade", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CategoryScoreDetails): CategoryScoreDetails {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CategoryScoreDetails, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class VitalScoreDetails$Type extends MessageType<VitalScoreDetails> {
    constructor() {
        super("SC2APIProtocol.VitalScoreDetails", [
            { no: 1, name: "life", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 2, name: "shields", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 3, name: "energy", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: VitalScoreDetails): VitalScoreDetails {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: VitalScoreDetails, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class ScoreDetails$Type extends MessageType<ScoreDetails> {
    constructor() {
        super("SC2APIProtocol.ScoreDetails", [
            { no: 1, name: "idle_production_time", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 2, name: "idle_worker_time", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 3, name: "total_value_units", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 4, name: "total_value_structures", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 5, name: "killed_value_units", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 6, name: "killed_value_structures", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 7, name: "collected_minerals", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 8, name: "collected_vespene", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 9, name: "collection_rate_minerals", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 10, name: "collection_rate_vespene", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 11, name: "spent_minerals", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 12, name: "spent_vespene", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 13, name: "food_used", kind: "message", T: () => CategoryScoreDetails },
            { no: 14, name: "killed_minerals", kind: "message", T: () => CategoryScoreDetails },
            { no: 15, name: "killed_vespene", kind: "message", T: () => CategoryScoreDetails },
            { no: 16, name: "lost_minerals", kind: "message", T: () => CategoryScoreDetails },
            { no: 17, name: "lost_vespene", kind: "message", T: () => CategoryScoreDetails },
            { no: 18, name: "friendly_fire_minerals", kind: "message", T: () => CategoryScoreDetails },
            { no: 19, name: "friendly_fire_vespene", kind: "message", T: () => CategoryScoreDetails },
            { no: 20, name: "used_minerals", kind: "message", T: () => CategoryScoreDetails },
            { no: 21, name: "used_vespene", kind: "message", T: () => CategoryScoreDetails },
            { no: 22, name: "total_used_minerals", kind: "message", T: () => CategoryScoreDetails },
            { no: 23, name: "total_used_vespene", kind: "message", T: () => CategoryScoreDetails },
            { no: 24, name: "total_damage_dealt", kind: "message", T: () => VitalScoreDetails },
            { no: 25, name: "total_damage_taken", kind: "message", T: () => VitalScoreDetails },
            { no: 26, name: "total_healed", kind: "message", T: () => VitalScoreDetails },
            { no: 27, name: "current_apm", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ },
            { no: 28, name: "current_effective_apm", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ScoreDetails): ScoreDetails {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* optional SC2APIProtocol.CategoryScoreDetails food_used */ 13:
                    message.foodUsed = CategoryScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.foodUsed);
                    break;
                case /* optional SC2APIProtocol.CategoryScoreDetails killed_minerals */ 14:
                    message.killedMinerals = CategoryScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.killedMinerals);
                    break;
                case /* optional SC2APIProtocol.CategoryScoreDetails killed_vespene */ 15:
                    message.killedVespene = CategoryScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.killedVespene);
                    break;
                case /* optional SC2APIProtocol.CategoryScoreDetails lost_minerals */ 16:
                    message.lostMinerals = CategoryScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.lostMinerals);
                    break;
                case /* optional SC2APIProtocol.CategoryScoreDetails lost_vespene */ 17:
                    message.lostVespene = CategoryScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.lostVespene);
                    break;
                case /* optional SC2APIProtocol.CategoryScoreDetails friendly_fire_minerals */ 18:
                    message.friendlyFireMinerals = CategoryScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.friendlyFireMinerals);
                    break;
                case /* optional SC2APIProtocol.CategoryScoreDetails friendly_fire_vespene */ 19:
                    message.friendlyFireVespene = CategoryScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.friendlyFireVespene);
                    break;
                case /* optional SC2APIProtocol.CategoryScoreDetails used_minerals */ 20:
                    message.usedMinerals = CategoryScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.usedMinerals);
                    break;
                case /* optional SC2APIProtocol.CategoryScoreDetails used_vespene */ 21:
                    message.usedVespene = CategoryScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.usedVespene);
                    break;
                case /* optional SC2APIProtocol.CategoryScoreDetails total_used_minerals */ 22:
                    message.totalUsedMinerals = CategoryScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.totalUsedMinerals);
                    break;
                case /* optional SC2APIProtocol.CategoryScoreDetails total_used_vespene */ 23:
                    message.totalUsedVespene = CategoryScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.totalUsedVespene);
                    break;
                case /* optional SC2APIProtocol.VitalScoreDetails total_damage_dealt */ 24:
                    message.totalDamageDealt = VitalScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.totalDamageDealt);
                    break;
                case /* optional SC2APIProtocol.VitalScoreDetails total_damage_taken */ 25:
                    message.totalDamageTaken = VitalScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.totalDamageTaken);
                    break;
                case /* optional SC2APIProtocol.VitalScoreDetails total_healed */ 26:
                    message.totalHealed = VitalScoreDetails.internalBinaryRead(reader, reader.uint32(), options, message.totalHealed);
                    break;
    ...
    internalBinaryWrite(message: ScoreDetails, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.foodUsed)
            CategoryScoreDetails.internalBinaryWrite(message.foodUsed, writer.tag(13, WireType.LengthDelimited).fork(), options).join();
        /* optional SC2APIProtocol.CategoryScoreDetails killed_minerals = 14; */
        if (message.killedMinerals)
            CategoryScoreDetails.internalBinaryWrite(message.killedMinerals, writer.tag(14, WireType.LengthDelimited).fork(), options).join();
        /* optional SC2APIProtocol.CategoryScoreDetails killed_vespene = 15; */
        if (message.killedVespene)
            CategoryScoreDetails.internalBinaryWrite(message.killedVespene, writer.tag(15, WireType.LengthDelimited).fork(), options).join();
        /* optional SC2APIProtocol.CategoryScoreDetails lost_minerals = 16; */
        if (message.lostMinerals)
            CategoryScoreDetails.internalBinaryWrite(message.lostMinerals, writer.tag(16, WireType.LengthDelimited).fork(), options).join();
        /* optional SC2APIProtocol.CategoryScoreDetails lost_vespene = 17; */
        if (message.lostVespene)
            CategoryScoreDetails.internalBinaryWrite(message.lostVespene, writer.tag(17, WireType.LengthDelimited).fork(), options).join();
        /* optional SC2APIProtocol.CategoryScoreDetails friendly_fire_minerals = 18; */
        if (message.friendlyFireMinerals)
            CategoryScoreDetails.internalBinaryWrite(message.friendlyFireMinerals, writer.tag(18, WireType.LengthDelimited).fork(), options).join();
        /* optional SC2APIProtocol.CategoryScoreDetails friendly_fire_vespene = 19; */
        if (message.friendlyFireVespene)
            CategoryScoreDetails.internalBinaryWrite(message.friendlyFireVespene, writer.tag(19, WireType.LengthDelimited).fork(), options).join();
        /* optional SC2APIProtocol.CategoryScoreDetails used_minerals = 20; */
        if (message.usedMinerals)
            CategoryScoreDetails.internalBinaryWrite(message.usedMinerals, writer.tag(20, WireType.LengthDelimited).fork(), options).join();
        /* optional SC2APIProtocol.CategoryScoreDetails used_vespene = 21; */
        if (message.usedVespene)
            CategoryScoreDetails.internalBinaryWrite(message.usedVespene, writer.tag(21, WireType.LengthDelimited).fork(), options).join();
        /* optional SC2APIProtocol.CategoryScoreDetails total_used_minerals = 22; */
        if (message.totalUsedMinerals)
            CategoryScoreDetails.internalBinaryWrite(message.totalUsedMinerals, writer.tag(22, WireType.LengthDelimited).fork(), options).join();
        /* optional SC2APIProtocol.CategoryScoreDetails total_used_vespene = 23; */
        if (message.totalUsedVespene)
            CategoryScoreDetails.internalBinaryWrite(message.totalUsedVespene, writer.tag(23, WireType.LengthDelimited).fork(), options).join();
        /* optional SC2APIProtocol.VitalScoreDetails total_damage_dealt = 24; */
        if (message.totalDamageDealt)
            VitalScoreDetails.internalBinaryWrite(message.totalDamageDealt, writer.tag(24, WireType.LengthDelimited).fork(), options).join();
        /* optional SC2APIProtocol.VitalScoreDetails total_damage_taken = 25; */
        if (message.totalDamageTaken)
            VitalScoreDetails.internalBinaryWrite(message.totalDamageTaken, writer.tag(25, WireType.LengthDelimited).fork(), options).join();
        /* optional SC2APIProtocol.VitalScoreDetails total_healed = 26; */
        if (message.totalHealed)
            VitalScoreDetails.internalBinaryWrite(message.totalHealed, writer.tag(26, WireType.LengthDelimited).fork(), options).join();
